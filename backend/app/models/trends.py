...
class TrendsSnapshotCache(Base):
    __tablename__ = "trends_snapshot_cache"
    ...
    search_filter: Mapped[str] = mapped_column(Text, default="", nullable=False)
    signature_json: Mapped[str] = mapped_column(Text, default="[]", nullable=False)
