...
FINANCE_TELEGRAM_COLUMNS: list[tuple[str, tuple[str, ...]]] = [
    ...
    ("delta", ("change",)),
    ("sales", ("sales",)),
    ("fee + acq.", ("fee", "acquiring")),
    ("pays", ("payments",)),
    ("payment commission", ("payment_commission",)),
    ("logistics", ("logistics",)),
    ("rev. log. + ret.", ("reverse_logistics", "returns")),
    ("cross + accept", ("cross_docking", "acceptance")),
    ("export", ("export",)),
    ("pickup point storage", ("pickup_point_storage",)),
    ("errors", ("errors",)),
    ("defects", ("defects",)),
    ("mutual offset", ("mutual_offset",)),
    ("decompensation", ("decompensation",)),
    ("disposal", ("disposal",)),
    ("storage", ("storage",)),
    ("ads", ("marketing",)),
    ("cpo", ("promotion_with_cpo",)),
    ("reviews", ("points_for_reviews",)),
    ("bonuses", ("seller_bonuses",)),
    ("check", ("check",)),
...
def build_finance_telegram_message(*, company_name: str, row: FinanceRow) -> str:
    ...
    for label, keys in FINANCE_TELEGRAM_COLUMNS:
        ...
        lines.append(f"{label}: {_format_value(value, is_percent=keys == ('logistics_pct',))}")
    return "\n".join(lines)
